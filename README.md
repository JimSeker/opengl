...
<b>HelloOpenGLES31</b> is Google’s basic framework example from 2.0, updated to opengl3.1.  2D square and triangle with touch events to spin the triangle.  The setEGLContextClientVersion(3);  maybe wrong, since I could not find how to set it for 3.1.
